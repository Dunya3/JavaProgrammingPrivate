...
// ovo ce printati sve sto nije letter znaci samo karaktere
        letters.removeIf(p -> Character.isLetter(p)); //Lambda remove the characters that are no letters

        System.out.println("letters = " + letters);
        
        ArrayList<Character> digits = new ArrayList<>(chars);
        // ovo je da sklonimo sve karaktere da na ostanu samo brojevi
        ...
        //ovako mozemo da isprintamo samo spacial charactere
       // specialChar.retainAll(letters); moze ovom metodom
       // specialChar.retainAll(digits);
        specialChar.removeIf( p-> Character.isLetterOrDigit(p)); //i ovo je drugi nacin
