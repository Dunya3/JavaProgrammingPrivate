...
public class DonateBlood {
    public static void main(String[] args) {
        ...
        // nested if and else    //citaj zadatak dobro
        ...
        if(age>=18){
            ...
            // Ternary
            System.out.println("======Ternary======"); //obicno na intervjuima ne pitaju da uradimo u ternary primeru
          //  String results = (age>=18)?(weight>50)?"You are eligible to donate bllod": "You are eligible to donate " : "Age must be greater than 18";
